...
print(word[15:18])
print(word[:-1])
print(len(word))#gives you the length of the sentence
print(word[:13])
print(word[5:])
#what if i wanted to find a substring
#a substring is a word inside a sentence

print(word.find("is"))#finds the index of the substring
print(word.find("and"))
#how do we uppercase all letters
print(word.upper())
#capitalizes first letter
print(word.capitalize())
#uppercase first letter in cool
cool=word[10:14]
print(cool)
